...
<body>
    ...
    if (isset($_POST['login'])) {
        ...
        $inpac = "INSERT INTO pacientes ('dniPac','pacNombres','pacApellidos','pacFechaNacimiento','pacSexo') VALUES ('$_POST[dni]','$_POST[nombre]','$_POST[apellidos]','$_POST[especialidad]','$_POST[telefono]','$_POST[email]')";
        $result = mysqli_query($_SESSION["con"], $inuser);
        $result = mysqli_query($_SESSION["con"], $inpac);
