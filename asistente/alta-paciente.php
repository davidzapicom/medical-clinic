    ...
    <section class="home">
        <div class="text">
            ...
            <form action="#" method="post">
                ...
                <br />
                <input type="text" name="apellidos" placeholder="Apellidos" value="<?php if (isset($_POST['alta']) && $_SESSION['check'] == 0) echo $apellidos; ?>" pattern="[A-Za-z[ ]A-Za-z]+" maxlength="20" oninvalid="this.setCustomValidity('Debes introducir solo letras.')" oninput="this.setCustomValidity('')" required>
                <br />
